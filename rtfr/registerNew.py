...
def upload_to_aws(local_file, bucket, s3_file):
	...
	try:
		# req_for_image = requests.get(local_file, stream=True)
		# file_object_from_req = req_for_image.raw
		# req_data = file_object_from_req.read()
		# s3.Bucket(BUCKET).put_object(Key=s3_file, Body=req_data)
		r = requests.get(local_file, stream=True)
		# bucket = s3.Bucket(BUCKET)
		s3.upload_fileobj(r.raw,bucket,s3_file)
		# s3.put_object(r.raw, bucket, s3_file)
